...
public class Data_Driven_Mortgage {
    public static void main(String[] args) throws IOException, BiffException, InterruptedException, WriteException {
        ...
        WritableWorkbook writeableFile = Workbook.createWorkbook(new File("src/main/resources/Mortgage_Info_Results.xls"),readableFile);
        ...
        for(int i = 1;i < rowCount;i++){
            ...
            Thread.sleep(2000);
            String result = Reusable_Methods.captureResult(driver,"//*[@class='left-cell']/following::h3[contains(text(),'$')]","");
            System.out.println("My montly payment is " + result);
